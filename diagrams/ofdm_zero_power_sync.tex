\begin{tikzpicture}
  ...
  \draw
  (0.1, -1.1) node[rcp]{}
  ++(0.4, 0) node[wsample, fill=ProcessBlue]{-3}
  ++(1.3, 0)node[rnarrow]{}
  ++(0.1, 0) node[wsample, fill=ForestGreen]{-2}
  ++(1.3, 0)node[rnarrow]{}
  ++(0.1, 0) node[wsample, fill=Goldenrod]{-1}

  ++(2.4, 0)node[rcp]{}
  ++(0.4, 0) node[wsample, fill=YellowGreen]{0}
  ++(1.3, 0)node[rnarrow]{}
  ++(0.1, 0) node[wsample, fill=WildStrawberry]{1}
  ++(1.3, 0)node[rnarrow]{}
  ++(0.1, 0) node[wsample, fill=Maroon]{2}
  ++(1.3, 0)node[rnarrow]{}
  ++(0.1, 0) node[wsample, fill=LimeGreen]{3};
